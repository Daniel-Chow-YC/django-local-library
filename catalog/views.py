...
## This view expects to find a template named with the format <modelName>_form.html. The "create" and "update" views use the same template by default. In this case catalog/templates/catalog/author_form.html
class AuthorCreate(PermissionRequiredMixin, CreateView):
    model = Author
    fields = '__all__'
    # initial = {'date_of_death': '05/01/2018'}
    permission_required = 'catalog.can_mark_returned'
    """By default, this view will redirect on success to a page displaying the newly created/edited model item"""
...
## The "delete" view expects to find a template named with the format <modelName>_confirm_delete.html
